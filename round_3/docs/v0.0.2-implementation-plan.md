...
| ID | Task | Status | Notes |
|----|------|--------|-------|
| 3.1 | Add ANTHROPIC_API_KEY support | ⏳ PENDING | Environment variable |
| 3.2 | Create ai_roaster.py | ⏳ PENDING | Claude client wrapper |
| 3.3 | Design prompt template | ⏳ PENDING | See below |
| 3.4 | AI roast generation | ⏳ PENDING | Generate personalized roasts |
| 3.5 | AI meme selection | ⏳ PENDING | Pick best template |
| 3.6 | Frontend AI toggle | ⏳ PENDING | "use_ai" checkbox |
| 3.7 | Fallback to captions | ⏳ PENDING | On API failure |
